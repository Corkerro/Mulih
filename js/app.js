(() => {
    ...
    (() => {
        ...
        for (let i = 0; i < menuItems.length; i++) menuItems[i].addEventListener("click", (() => {
            if (!menuItems[i].classList.contains("_active")) {
                for (let j = 0; j < menuItems.length; j++) menuItems[j].classList.remove("_active");
